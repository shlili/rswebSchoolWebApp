        ...
        public static void Initialize(IServiceProvider serviceProvider)
        {
            ...
            DbContextOptions<MVCSchoolAppContext>>()))
            {
                ...
                new Course
                {
                    ...
                    SecondTeacherId= context.Teacher.Single(d => d.FirstName =="Ivan" && d.LastName == "Reitman").TeacherId,
                    EducationLevel = "BS"
                },
                new Course
                {
                    ...
                    Credits=7,
                    Semester=3,
                    FirstTeacherId = context.Teacher.Single(d => d.FirstName == "Glenn" && d.LastName == "Sturgis").TeacherId,
